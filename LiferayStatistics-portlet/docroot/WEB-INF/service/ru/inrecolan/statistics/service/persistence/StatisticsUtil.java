...
/**
 * The persistence utility for the statistics service. This utility wraps {@link StatisticsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class StatisticsUtil {
	 ...
	 */
	public static void clearCache(Statistics statistics) {
		getPersistence().clearCache(statistics);
	}
	 ...
	 */
	public static List<Statistics> findWithDynamicQuery(
	 ...
	 */
	public static Statistics update(Statistics statistics, boolean merge)
		throws SystemException {
		return getPersistence().update(statistics, merge);
	}
	...
	public static Statistics update(Statistics statistics, boolean merge,
		...
		return getPersistence().update(statistics, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(statisticses);
	}
	...
	*/
	public static ru.inrecolan.statistics.model.Statistics create(long statId) {
	...
	*/
	public static ru.inrecolan.statistics.model.Statistics remove(long statId)
		throws com.liferay.portal.kernel.exception.SystemException,
			ru.inrecolan.statistics.NoSuchStatisticsException {
		return getPersistence().remove(statId);
	}

	public static ru.inrecolan.statistics.model.Statistics updateImpl(
		ru.inrecolan.statistics.model.Statistics statistics, boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(statistics, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static ru.inrecolan.statistics.model.Statistics findByPrimaryKey(
		long statId)
		throws com.liferay.portal.kernel.exception.SystemException,
			ru.inrecolan.statistics.NoSuchStatisticsException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static ru.inrecolan.statistics.model.Statistics fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<ru.inrecolan.statistics.model.Statistics> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static StatisticsPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (StatisticsPersistence)PortletBeanLocatorUtil.locate(ru.inrecolan.statistics.service.ClpSerializer.getServletContextName(),
					StatisticsPersistence.class.getName());

			ReferenceRegistry.registerReference(StatisticsUtil.class,
				"_persistence");
		}
	 ...
	 * @deprecated
	 */
	public void setPersistence(StatisticsPersistence persistence) {
	}

	private static StatisticsPersistence _persistence;
}